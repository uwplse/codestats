...
public class QueryParser implements QueryParserConstants {
  ...
  static final public List<Query> program() throws ParseException {List<Query> blocks = new ArrayList();
    Query block;
    label_1:
    while (true) {
...
{if ("" != null) return blocks;}
  ...
  static final public Query block() throws ParseException {Token name;
    Token deriving = null;
    Metric metric;
    QueryTarget target;
...
{if ("" != null) return new Query(name.image, deriving == null ? null : deriving.image, metric, target, pred);}
  ...
  static final public PredicateMirror Predicate() throws ParseException {PredicateMirror pred;
    pred = conjunction();
{if ("" != null) return pred;}
    throw new Error("Missing return statement in function");
  }

  static final public PredicateMirror conjunction() throws ParseException {List<PredicateMirror> children = new ArrayList<PredicateMirror>();
...
{if ("" != null) return new PredicateMirror(PredicateMirror.PredicateType.AND, children);}
  ...
  static final public PredicateMirror disjunction() throws ParseException {List<PredicateMirror> children = new ArrayList<PredicateMirror>();
    PredicateMirror child;
    child = atom();
children.add(child);
    label_3:
...
{if ("" != null) return null;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80000,0x60,0x180,0x200,0x800,0x1000,0x800000,0x70000,0x70000,0x8000,0x800000,0x800000,0x2000000,0x800000,0x84000,};
   }
